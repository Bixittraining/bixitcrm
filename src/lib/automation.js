...
export const AUTOMATION_EVENTS = {
  ...
  FOLLOW_UP_OUTCOME_RECORDED: 'FOLLOW_UP_OUTCOME_RECORDED',
  NEXT_FOLLOW_UP_CREATED: 'NEXT_FOLLOW_UP_CREATED',
  ...
  // ── Student lifecycle (post-enrollment) ──
  STUDENT_BATCH_CHANGED: 'STUDENT_BATCH_CHANGED',
...
export const AUTOMATION_RULES = {
  ...
  [AUTOMATION_EVENTS.FOLLOW_UP_RESCHEDULED]: [],
  [AUTOMATION_EVENTS.FOLLOW_UP_CANCELLED]: [],
  [AUTOMATION_EVENTS.FOLLOW_UP_OUTCOME_RECORDED]: [],
  [AUTOMATION_EVENTS.NEXT_FOLLOW_UP_CREATED]: [],
  ...
  [AUTOMATION_EVENTS.STUDENT_BATCH_CHANGED]: [],
  [AUTOMATION_EVENTS.STUDENT_STATUS_CHANGED]: [],
  [AUTOMATION_EVENTS.STUDENT_COMPLETED]: [],
  [AUTOMATION_EVENTS.STUDENT_PROGRESS_UPDATED]: [],
}
